...
class ShortStory {
    ...
    render() {
        ...
        return (h("div", { class: "short-story" },
            h("div", { class: "component-row" },
                h("div", { class: "component-container" }, this.showWidth ? (h("ssy-width-measure", { content: children })) : (children))),
            h("div", { class: "inputs-container" }, this.inputs)));
    }
...
class ShortStoryNumberInput {
    ...
    render() {
        return [this.content, h("div", { class: "width-measure" },
                this.width,
                "px")];
    }
    static get is() { return "ssy-width-measure"; }
    static get encapsulation() { return "shadow"; }
    static get properties() { return {
        "content": {
            "type": "Any",
...
export { ShortStory, ShortStoryNumberInput as SsyWidthMeasure };
