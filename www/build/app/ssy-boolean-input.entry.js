...
class ShortStoryBooleanInput {
    ...
    render() {
        return (h("div", { class: "input" },
            ...
            h("input", { id: `stsy_boolean_input_${this.label}`, name: `stsy_boolean_input_${this.label}`, type: 'checkbox', onChange: this.inputChanged, value: this.value })));
    }
    static get is() { return "ssy-boolean-input"; }
...
export { ShortStoryBooleanInput as SsyBooleanInput };
